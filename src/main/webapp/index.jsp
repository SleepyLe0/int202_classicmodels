...
<head>
    ...
    <script>
        ...
        function login(userName, password) {
            ...
            let urlEncodedData = "", urlEncodedDataParis = [];
            urlEncodedDataParis.push(encodeURIComponent("userName") + '=' + encodeURIComponent(userName));
            urlEncodedDataParis.push(encodeURIComponent("password") + '=' + encodeURIComponent(password));
            urlEncodedData = urlEncodedDataParis.join('&').replace(/%20/g, '+');
...
<nav class="navbar navbar-expand-sm navbar-dark bg-dark">
    <div class="container-fluid"><a class="navbar-brand text-warning" href="">Classic Model</a>
...
<jsp:include page="WEB-INF/jsp/login-form.html" flush="true" />
</body>
</html>